...
impl Game {
    ...
    pub fn run(mut self) -> Result<(), Box<Error>> {
        ...
        info!(" _____            _       _____ _    _ _ _  ___  ___           _       _    _       _    _");
        info!("/  ___|          | |     /  ___| |  (_) | | |  \\/  |          | |     | |  | |     | |  | |");
        info!("\\ `--. _   _  ___| |__   \\ `--.| | ___| | | | .  . |_   _  ___| |__   | |  | | ___ | |  | |");
        info!(" `--. \\ | | |/ __| '_ \\   `--. \\ |/ / | | | | |\\/| | | | |/ __| '_ \\  | |/\\| |/ _ \\| |/\\| |");
        info!("/\\__/ / |_| | (__| | | | /\\__/ /   <| | | | | |  | | |_| | (__| | | | \\  /\\  / (_) \\  /\\  /");
        info!("\\____/ \\__,_|\\___|_| |_| \\____/|_|\\_\\_|_|_| \\_|  |_/\\__,_|\\___|_| |_|  \\/  \\/ \\___/ \\/  \\/ ");
